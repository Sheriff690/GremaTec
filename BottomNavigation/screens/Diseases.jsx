...
import { DUMMY_DATA } from '../../assets/DeseasesDeatails';
          ...
          <ScrollView>
            <View style={{
              ...
              <View style={{height:80}}>
                <Text style={{color: '#ffffff', alignSelf: 'flex-start', marginHorizontal:14}}>
                  {item.overview}
                </Text>
              </View>
            </View>
                ...
                <View style ={styles.modelView}>
                  ...
                  <View style ={styles.modalBody}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                      <View style={{marginBottom: 80, paddingHorizontal:12}}>
                        <Text style={{
                          color:'black',
